...
public abstract class AnnotationUtils {
	...
	private static transient Map<CacheKey, Annotation> annotationCache = new ConcurrentHashMap<CacheKey, Annotation>(32);
	...
	private static class CacheKey {
		...
		public CacheKey(Class clazz, Class annotationType) {
			this.clazz = clazz;
		...
		@Override
		public int hashCode() {
			return Arrays.hashCode(new Object[]{clazz, annotationType});
		}
		
		@Override
		public boolean equals(Object obj) {
			if(obj instanceof CacheKey) {
				return clazz.equals(((CacheKey) obj).clazz) && annotationType.equals(((CacheKey) obj).annotationType);
			}
			return false;
		}
	}
	...
	public static <A extends Annotation> A findAnnotation(Class<?> clazz, Class<A> annotationType) {
		CacheKey key = new CacheKey(clazz, annotationType);
		A annotation = (A) annotationCache.get(key);
		if(annotation == null) {
			annotation = findAnnotationInternal(clazz, annotationType);
			if(annotation != null) {
	...
	private static <A extends Annotation> A findAnnotationInternal(Class<?> clazz, Class<A> annotationType) {
